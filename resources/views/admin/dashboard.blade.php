    ...
    <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 mb-10">
        ...
        <div class="bg-white p-6 rounded-2xl border border-gray-100 shadow-sm">
            ...
            <div class="flex items-end justify-between">
                <h3 class="text-2xl font-bold text-gray-900 tabular-nums">RM{{ number_format($totalNetIncome + $networkVolume, 0) }}</h3>
        ...
        <div class="bg-white p-6 rounded-2xl border border-gray-100 shadow-sm">
            ...
            <div class="flex items-end justify-between">
                <h3 class="text-2xl font-bold text-gray-900 tabular-nums">RM{{ number_format($storefrontRevenue, 0) }}</h3>
        ...
        <div class="bg-white p-6 rounded-2xl border border-gray-100 shadow-sm">
            ...
            <div class="flex items-end justify-between">
                <h3 class="text-2xl font-bold text-gray-900 tabular-nums">RM{{ number_format($networkVolume, 0) }}</h3>
        ...
        <div class="bg-white p-6 rounded-2xl border border-gray-100 shadow-sm">
            ...
            <div class="flex items-end justify-between">
                <h3 class="text-2xl font-bold text-gray-900 tabular-nums">RM{{ number_format($totalNetIncome, 0) }}</h3>
        ...
        <div class="bg-white p-8 rounded-2xl border border-gray-100 shadow-sm">
            ...
            <div class="h-[200px] relative flex items-center justify-center">
                ...
                <div class="absolute flex flex-col items-center pointer-events-none">
                    <span class="text-xl font-bold text-gray-900">RM{{ number_format($storefrontRevenue + $networkVolume, 0) }}</span>
            ...
            <div class="mt-8 space-y-3">
                <div class="flex justify-between items-center text-xs">
                    ...
                    <span class="font-bold text-gray-900">RM{{ number_format($storefrontRevenue, 0) }}</span>
                </div>
                <div class="flex justify-between items-center text-xs">
                    <div class="flex items-center gap-2">
                        <span class="w-2 h-2 rounded-full bg-purple-500"></span>
                    ...
                    <span class="font-bold text-gray-900">RM{{ number_format($networkVolume, 0) }}</span>
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 mb-10">
        ...
        <div class="bg-white rounded-2xl border border-gray-100 shadow-sm overflow-hidden">
            ...
            <div class="divide-y divide-gray-50">
                @foreach($recentStorefrontSales->take(4) as $sale)
        ...
        <div class="bg-white rounded-2xl border border-gray-100 shadow-sm overflow-hidden">
            ...
            <div class="divide-y divide-gray-50">
                @foreach($recentResellerSales->take(4) as $sale)
                    <div class="px-6 py-4 flex items-center justify-between hover:bg-gray-50/50 transition-all">
                        <div>
                            <p class="text-xs font-bold text-gray-900 truncate w-32">{{ $sale->user->name }}</p>
                            <p class="text-[9px] text-gray-400 uppercase tracking-widest mt-0.5">{{ $sale->created_at->diffForHumans() }}</p>
                        </div>
                        <span class="text-xs font-bold text-gray-900">RM{{ number_format($sale->total_price, 0) }}</span>
                    </div>
    ...
    <script>
        ...
        new Chart(document.getElementById('channelShareChart'), {
            ...
            data: {
                ...
                datasets: [{
                    data: [{{ $storefrontRevenue }}, {{ $networkVolume }}],
