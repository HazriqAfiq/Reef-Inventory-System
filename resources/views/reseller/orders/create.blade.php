    ...
    <div class="max-w-full pb-44" x-data="{ cartOpen: false, search: '', activeCategory: 'all' }">
        ...
        <div class="flex flex-col md:flex-row md:items-center justify-between gap-6 mb-12">
            <div>
                ...
                <p class="text-sm text-gray-500 mt-1.5">Replenish your local stock directly from HQ. Orders require a Minimum Order Quantity (MOQ) of {{ $totalMoq }} items total.</p>
            </div>
            <div class="flex items-center gap-3 shrink-0">
                <a href="{{ route('reseller.orders.index') }}" class="inline-flex items-center gap-2 px-6 py-3 bg-white border border-gray-200 text-gray-700 hover:text-black hover:border-black text-xs font-bold uppercase tracking-widest rounded-xl transition-all shadow-sm">
