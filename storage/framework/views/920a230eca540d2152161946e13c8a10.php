...
<?php endif; ?>
<?php $component->withAttributes(['title' => 'Partner Workspace']); ?>
    <!-- Page Header -->
    <div class="mb-10">
    ...
    <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 mb-10">
        ...
        <div class="bg-white p-6 rounded-2xl border border-gray-100 shadow-sm">
            ...
            <div class="flex items-end justify-between">
                <h3 class="text-2xl font-bold text-gray-900 tabular-nums">RM<?php echo e(number_format($myTotalRevenue, 0)); ?></h3>
                <span class="text-[10px] font-bold text-gray-500 bg-gray-50 px-2 py-1 rounded-lg"><?php echo e(number_format($myTotalSales)); ?> txns</span>
            </div>
        </div>
        ...
        <div class="bg-white p-6 rounded-2xl border border-gray-100 shadow-sm">
            ...
            <div class="flex items-end justify-between">
                <h3 class="text-2xl font-bold text-gray-900 tabular-nums">RM<?php echo e(number_format($thisMonthRevenue, 0)); ?></h3>
                <?php if($revenueChange !== null): ?>
                    <span class="text-[10px] font-bold <?php echo e($revenueChange >= 0 ? 'text-emerald-600 bg-emerald-50' : 'text-rose-600 bg-rose-50'); ?> px-2 py-1 rounded-lg">
                        <?php echo e($revenueChange >= 0 ? '+' : ''); ?><?php echo e($revenueChange); ?>%
                    </span>
                <?php endif; ?>
            </div>
        </div>
        ...
        <div class="bg-white p-6 rounded-2xl border border-gray-100 shadow-sm">
            ...
            <div class="flex items-end justify-between">
                <h3 class="text-2xl font-bold text-gray-900 tabular-nums">RM<?php echo e(number_format($myCommission, 0)); ?></h3>
        ...
        <div class="bg-white p-6 rounded-2xl border border-gray-100 shadow-sm">
            ...
            <div class="flex items-end justify-between">
                <h3 class="text-2xl font-bold text-gray-900 tabular-nums"><?php echo e(number_format($myTotalUnits)); ?></h3>
                <span class="text-[10px] font-bold <?php echo e($lowStockProducts->count() > 0 ? 'text-amber-600 bg-amber-50' : 'text-gray-500 bg-gray-50'); ?> px-2 py-1 rounded-lg">
                    <?php echo e($lowStockProducts->count() > 0 ? $lowStockProducts->count() . ' Low' : 'Stable'); ?>
    ...
    <div class="grid grid-cols-1 lg:grid-cols-3 gap-8 mb-10">
        ...
        <div class="bg-white rounded-2xl border border-gray-100 shadow-sm overflow-hidden relative" x-data="{ editing: false }">
                    ...
                    <div class="flex flex-col items-center gap-4">
                        <div class="relative w-28 h-28 flex items-center justify-center">
                            <svg class="w-full h-full transform -rotate-90">
                                ...
                                <circle cx="56" cy="56" r="50" stroke="currentColor" stroke-width="6" fill="transparent" class="text-black" stroke-dasharray="<?php echo e(2 * pi() * 50); ?>" stroke-dashoffset="<?php echo e((1 - ($goalProgress / 100)) * (2 * pi() * 50)); ?>" style="transition: stroke-dashoffset 1s ease-in-out;"/>
                            </svg>
                            <div class="absolute flex flex-col items-center">
                                <span class="text-xl font-bold text-gray-900"><?php echo e($goalProgress); ?>%</span>
                            </div>
                        </div>
                        <div class="text-center">
                            <p class="text-[10px] font-bold text-gray-400 uppercase tracking-wider mb-1">Target</p>
                            <h4 class="text-lg font-bold text-gray-900">RM<?php echo e(number_format($monthlyGoal, 0)); ?></h4>
                            <p class="text-[10px] font-bold text-gray-400 mt-1">RM<?php echo e(number_format($thisMonthRevenue, 2)); ?> earned</p>
                        </div>
                    </div>
                <?php else: ?>
            ...
            <div x-show="editing" x-cloak class="absolute inset-0 bg-white/95 backdrop-blur-sm z-20 p-6 flex flex-col justify-center rounded-2xl">
                <form action="<?php echo e(route('reseller.dashboard.goal')); ?>" method="POST" class="space-y-5">
                    <?php echo csrf_field(); ?>
                    <div>
                        <label class="text-[10px] font-bold text-gray-400 uppercase tracking-wider mb-3 block text-center">Monthly Goal (RM)</label>
                        <input type="number" name="monthly_goal" value="<?php echo e($monthlyGoal); ?>" class="w-full bg-gray-50 border-gray-100 rounded-xl px-4 py-3 text-center text-xl font-bold focus:ring-2 focus:ring-black/10 focus:border-black transition-all">
                    </div>
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 gap-8 mb-10">
        ...
        <div class="bg-white rounded-2xl border border-gray-100 shadow-sm overflow-hidden">
            <div class="px-6 py-4 border-b border-gray-50 bg-gray-50/30 flex items-center justify-between">
                ...
                <a href="<?php echo e(route('reseller.orders.create')); ?>" class="text-[10px] font-bold text-gray-400 hover:text-black uppercase tracking-wider transition-colors">Restock</a>
            </div>
            <div class="p-6 space-y-4">
                <?php $__empty_1 = true; $__currentLoopData = $lowStockProducts->take(4); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $p): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                    <?php
                    ...
                    ?>
                    <div class="flex items-center gap-4">
                        <div class="w-2 h-2 rounded-full <?php echo e($dotColor); ?>"></div>
                        <div class="flex-1">
                            <p class="text-xs font-bold text-gray-900"><?php echo e($p->product?->name); ?></p>
                            <p class="text-[10px] text-gray-400 uppercase tracking-widest mt-0.5"><?php echo e($p->quantity); ?> units remaining</p>
                        </div>
                    </div>
        ...
        <div class="bg-white rounded-2xl border border-gray-100 shadow-sm overflow-hidden">
            <div class="px-6 py-4 border-b border-gray-50 bg-gray-50/30 flex items-center justify-between">
                ...
                <a href="<?php echo e(route('reseller.sales.index')); ?>" class="text-[10px] font-bold text-gray-400 hover:text-black uppercase tracking-wider transition-colors">View All</a>
            </div>
            <div class="divide-y divide-gray-50">
                <?php $__empty_1 = true; $__currentLoopData = $myRecentSales->take(4); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $sale): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
    ...
    <script>
        ...
        new Chart(document.getElementById('topSellersChart'), {
            ...
            data: {
                ...
                datasets: [{
                    data: <?php echo json_encode($topProductData, 15, 512) ?>,
