    ...
    <div class="max-w-full">
        ...
        <div class="flex flex-col sm:flex-row sm:items-center justify-between gap-6 mb-10">
            ...
            <div class="flex items-center gap-2 shrink-0">
                <a href="<?php echo e(route('reseller.sales.index')); ?>" class="inline-flex items-center gap-2 px-6 py-3 bg-white border border-gray-100 text-gray-400 hover:text-black text-xs font-bold uppercase tracking-widest rounded-xl transition-all shadow-sm">
        ...
        <div class="bg-white rounded-2xl border border-gray-100 shadow-sm overflow-hidden">
            ...
            <!-- Form Body -->
            <form id="sale-form" action="<?php echo e(route('reseller.sales.store')); ?>" method="POST" class="p-8">
                <?php echo csrf_field(); ?>
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div>
                            ...
                            <div class="flex items-center gap-3">
                                ...
                                <input id="quantity" name="quantity" type="number" min="1" value="<?php echo e(old('quantity', 1)); ?>" required
...
<?php endif; ?>
<?php /**PATH C:\Users\USER\Documents\Project Code\reef_inventory\resources\views/reseller/sales/create.blade.php ENDPATH**/ ?>