                            ...
                            <select @change="if($event.target.value) { skuInput = $event.target.value; lookupProduct(); $event.target.value = ''; }"
                                ...
                                <?php $__currentLoopData = $products; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $product): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <option value="<?php echo e($product->sku); ?>">
                                        <?php echo e($product->name); ?> (<?php echo e($product->stock); ?> LEFT)
                                    </option>
...
<?php endif; ?>
<?php /**PATH C:\Users\USER\Documents\Project Code\reef_inventory\resources\views/admin/sales/create.blade.php ENDPATH**/ ?>