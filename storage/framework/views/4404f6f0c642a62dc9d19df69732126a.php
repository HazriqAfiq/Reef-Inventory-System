            ...
            <div class="space-y-8">
                ...
                <div class="grid grid-cols-1 md:grid-cols-3 gap-8">
                    <div class="space-y-2">
                        ...
                        <input id="retail_price" name="retail_price" type="number" step="0.01" value="<?php echo e(old('retail_price')); ?>"
                               class="w-full px-4 py-3 text-sm font-bold text-gray-900 bg-gray-50 border border-gray-100 rounded-xl focus:border-black focus:ring-0 transition-all">
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div class="space-y-2">
                        ...
                        <input id="wholesale_price" name="wholesale_price" type="number" step="0.01" value="<?php echo e(old('wholesale_price')); ?>"
                               class="w-full px-4 py-3 text-sm font-bold text-gray-900 bg-gray-50 border border-gray-100 rounded-xl focus:border-black focus:ring-0 transition-all">
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div class="space-y-2">
                        ...
                        <input id="stock" name="stock" type="number" value="<?php echo e(old('stock', 0)); ?>" min="0"
                               class="w-full px-4 py-3 text-sm font-bold text-gray-900 bg-gray-50 border border-gray-100 rounded-xl focus:border-black focus:ring-0 transition-all">
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.toggle','data' => ['name' => 'is_active','checked' => old('is_active', true),'label' => 'Active Availability','description' => 'Controls product visibility across reseller dashboards and POS.']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php endif; ?>
<?php $component->withAttributes(['name' => 'is_active','checked' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute(old('is_active', true)),'label' => 'Active Availability','description' => 'Controls product visibility across reseller dashboards and POS.']); ?>
...
<?php endif; ?>
<?php /**PATH C:\Users\USER\Documents\Project Code\reef_inventory\resources\views/admin/products/create.blade.php ENDPATH**/ ?>