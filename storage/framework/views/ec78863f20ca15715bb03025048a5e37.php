...
<?php endif; ?>
<?php $component->withAttributes(['title' => 'Scan & Restock']); ?>
                        ...
                        <div class="space-y-2">
                            ...
                            <select @change="if($event.target.value) { skuInput = $event.target.value; lookupProduct(); $event.target.value = ''; }"
                                ...
                                <?php $__currentLoopData = $products; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $product): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <option value="<?php echo e($product->sku); ?>">
                                        <?php echo e($product->name); ?> (<?php echo e($product->stock); ?> ON HAND)
                                    </option>
...
<?php endif; ?>
<?php /**PATH C:\Users\USER\Documents\Project Code\reef_inventory\resources\views/admin/inventory/scan-in.blade.php ENDPATH**/ ?>