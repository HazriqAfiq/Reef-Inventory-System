            ...
            <?php $__empty_1 = true; $__currentLoopData = $orders; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $order): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                <tr class="hover:bg-gray-50/50 transition-colors">
                    ...
                    <td class="px-6 py-4">
                        ...
                        <p class="text-[9px] text-gray-400 font-bold uppercase tracking-widest mt-0.5"><?php echo e($order->created_at->format('d M Y \a\t h:i A')); ?></p>
                    </td>
                    ...
                    <td class="px-6 py-4">
                        <div class="flex items-center gap-3">
                            ...
                            <div>
                                <div class="font-bold text-gray-900 leading-none"><?php echo e($order->user->name); ?></div>
                                <div class="text-[9px] text-gray-400 font-bold uppercase tracking-wider mt-1 truncate max-w-[150px]"><?php echo e($order->user->email); ?></div>
                            </div>
                        </div>
                    </td>
...
<?php endif; ?>
<?php /**PATH C:\Users\USER\Documents\Project Code\reef_inventory\resources\views/admin/orders/partials/table.blade.php ENDPATH**/ ?>