<?php if(request()->ajax()): ?>
    <title><?php echo e(isset($title) ? $title . ' — ' : ''); ?>Reef Store</title>
        ...
        <div class="h-16 lg:h-24 flex items-center justify-center px-5 lg:px-7 border-b border-gray-50 shrink-0 relative z-10">
            <a href="<?php echo e(Auth::check() && Auth::user()->isAdmin() ? route('admin.dashboard') : (Auth::check() ? route('reseller.dashboard') : '/')); ?>"
               class="flex items-center gap-3 transition-transform hover:scale-[1.02]">
                ...
                <?php else: ?>
                    <div class="w-9 h-9 rounded-xl bg-brand shadow-lg shadow-brand/10 flex items-center justify-center shrink-0">
            ...
            <?php if(auth()->guard()->check()): ?>
                <?php if(Auth::user()->isAdmin()): ?>
                    ...
                    <a href="<?php echo e(route('admin.reports.index')); ?>"
                       class="sidebar-link group <?php echo e(request()->routeIs('admin.reports.*') ? 'active' : ''); ?>" onclick="closeSidebar()">
                ...
                <?php elseif(Auth::user()->isReseller()): ?>
                    ...
                    <a href="<?php echo e(route('reseller.reports.index')); ?>"
                       class="sidebar-link group <?php echo e(request()->routeIs('reseller.reports.index') ? 'active' : ''); ?>" onclick="closeSidebar()">
                    ...
                    <a href="<?php echo e(route('reseller.audit.index')); ?>"
                       class="sidebar-link group <?php echo e(request()->routeIs('reseller.audit.index') ? 'active' : ''); ?>" onclick="closeSidebar()">
                    ...
                    <a href="<?php echo e(route('reseller.orders.create')); ?>"
                       class="sidebar-link group <?php echo e(request()->routeIs('reseller.orders.create') ? 'active' : ''); ?>" onclick="closeSidebar()">
                    ...
                    <a href="<?php echo e(route('reseller.orders.index')); ?>"
                       class="sidebar-link group <?php echo e(request()->routeIs('reseller.orders.index') || request()->routeIs('reseller.orders.show') || request()->routeIs('reseller.orders.payment') || request()->routeIs('reseller.orders.invoice') ? 'active' : ''); ?>" onclick="closeSidebar()">
                        <svg class="w-4 h-4 shrink-0 text-gray-500 group-hover:text-black" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2.5">
...
<?php endif; ?>
<?php /**PATH C:\Users\USER\Documents\Project Code\reef_inventory\resources\views/layouts/app.blade.php ENDPATH**/ ?>