                    ...
                    <?php if(Auth::user()->isReseller()): ?>
                        ...
                        <a href="<?php echo e(route('reseller.orders.create')); ?>" 
                           ...
                           title="View Wholesale Cart">
                            ...
                            <span id="global-header-cart-badge" class="<?php echo e($globalCartCount > 0 ? '' : 'hidden'); ?> absolute -top-1 -right-1 min-w-[18px] h-[18px] px-1 rounded-full bg-black text-white text-[9px] font-black flex items-center justify-center border-2 border-white shadow-sm">
