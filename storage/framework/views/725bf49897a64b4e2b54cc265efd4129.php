                ...
                <div class="w-full lg:pr-[300px] xl:pr-[360px] space-y-8">
                    ...
                    <div class="flex flex-col md:flex-row md:items-center md:justify-between gap-4">
                        <div>
                            ...
                            <p class="text-xs text-gray-400 mt-1">Replenish your local stock directly from HQ. Orders require a Minimum Order Quantity (MOQ) of <?php echo e($totalMoq); ?> items total.</p>
                        </div>
                    </div>
                                    ...
                                    <div class="pt-4 mt-5 border-t border-gray-100 flex flex-col gap-4">
                                        ...
                                        <div class="flex items-start justify-between gap-2">
                                            <div>
                                                ...
                                                <p class="text-base font-black text-gray-900 mt-1 leading-none">RM<?php echo e(number_format($product->wholesale_price, 2)); ?></p>
                                            </div>
                                            <div class="text-right">
                                                <?php if($isLowStock): ?>
                                                    <span class="inline-block text-[8px] font-black text-rose-600 uppercase tracking-wider bg-rose-50 border border-rose-100 px-2 py-1 rounded-md leading-tight animate-pulse">Clear Stock (<?php echo e($product->stock); ?>)</span>
                                                <?php else: ?>
                                                    <span class="inline-block text-[8px] font-black text-amber-600 uppercase tracking-wider bg-amber-50 border border-amber-100 px-2 py-1 rounded-md leading-tight">Min. <?php echo e($productMoq); ?> units</span>
                                                <?php endif; ?>
                                            </div>
                                        </div>
                                        ...
                                        <div class="relative w-full">
                                            ...
                                            <input type="hidden" class="product-volume" value="<?php echo e($product->volume_ml); ?>">
                                            ...
                                            <button type="button" 
                                                    class="add-to-cart-btn w-full py-3 bg-black hover:bg-gray-800 text-white text-[10px] font-bold uppercase tracking-widest rounded-xl transition-all shadow-sm active:scale-[0.98] flex items-center justify-center gap-1.5 <?php echo e($product->stock === 0 ? 'opacity-30 cursor-not-allowed pointer-events-none' : ''); ?>"
                                            ...
                                            <div class="qty-counter-widget hidden items-center justify-between bg-gray-50 border border-gray-100 p-1.5 rounded-xl w-full">
                                                ...
                                                <div class="flex-1 flex items-center justify-center">
                                                    <input type="number" 
                                                           ...
                                                           class="qty-input w-12 text-center text-xs font-black border-transparent bg-transparent p-0 focus:ring-0 text-gray-900 tabular-nums <?php echo e($isLowStock ? 'pointer-events-none bg-rose-50/50 rounded text-rose-600' : ''); ?>" 
                                                           data-counter="<?php echo e($counter); ?>"
