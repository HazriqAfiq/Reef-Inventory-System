                                    ...
                                    <div class="pt-4 mt-5 border-t border-gray-100 flex flex-col gap-4">
                                        ...
                                        <div class="flex items-start justify-between gap-2">
                                            ...
                                            <div class="text-right">
                                                <?php if($isLowStock): ?>
                                                    <span class="inline-block text-[8px] font-black text-rose-600 uppercase tracking-wider bg-rose-50 border border-rose-100 px-2 py-1 rounded-md leading-none whitespace-nowrap animate-pulse">Clear Stock: Buy All (<?php echo e($product->stock); ?>)</span>
                                                <?php else: ?>
                                                    <span class="inline-block text-[8px] font-black text-amber-600 uppercase tracking-wider bg-amber-50 border border-amber-100 px-2 py-1 rounded-md leading-none whitespace-nowrap">Min. <?php echo e($productMoq); ?> units</span>
                                                <?php endif; ?>
                                            </div>
                                        </div>
