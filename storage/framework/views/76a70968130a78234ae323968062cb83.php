                ...
                <div class="mb-12 text-center lg:text-left">
                    <a href="/" class="inline-block group mb-10">
                        <h2 class="text-xl font-luxury font-black tracking-[0.3em] uppercase text-black">
                            <?php echo e(\App\Models\Setting::getValue('brand_name', 'Reef Store')); ?>
...
<?php endif; ?>
<?php /**PATH C:\Users\USER\Documents\Project Code\reef_inventory\resources\views/auth/login.blade.php ENDPATH**/ ?>