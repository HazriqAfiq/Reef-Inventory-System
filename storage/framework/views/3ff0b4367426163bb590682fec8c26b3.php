    ...
    <div class="grid grid-cols-1 md:grid-cols-3 gap-8 mb-10">
        ...
        <div class="bg-white p-6 rounded-2xl border border-gray-100 shadow-sm flex items-center gap-5">
            ...
            <div>
                ...
                <p class="text-2xl font-bold text-gray-900 leading-none tabular-nums"><?php echo e($totalResellers); ?></p>
            </div>
        </div>
        ...
        <div class="bg-white p-6 rounded-2xl border border-gray-100 shadow-sm flex items-center gap-5">
            ...
            <div>
                ...
                <p class="text-2xl font-bold text-gray-900 leading-none tabular-nums"><?php echo e(number_format($totalSalesCount)); ?></p>
            </div>
        </div>
        ...
        <div class="bg-white p-6 rounded-2xl border border-gray-100 shadow-sm flex items-center gap-5">
            ...
            <div>
                ...
                <p class="text-2xl font-bold text-gray-900 leading-none tabular-nums">RM<?php echo e(number_format($totalRevenue, 2)); ?></p>
            </div>
        </div>
    </div>
