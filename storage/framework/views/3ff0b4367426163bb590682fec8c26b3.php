...
<?php endif; ?>
<?php $component->withAttributes(['title' => 'Manage Resellers']); ?>
    ...
    <div class="mb-8 flex flex-col md:flex-row md:items-center md:justify-between gap-4">
        ...
        <div class="flex items-center gap-3 shrink-0">
            <a href="<?php echo e(route('admin.resellers.create')); ?>"
    ...
    <div class="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
        ...
        <div class="bg-white p-6 rounded-2xl border border-gray-100 shadow-sm hover:shadow-md transition-all group duration-300 flex flex-col justify-between h-full">
            ...
            <div>
                <h3 class="text-2xl font-black text-gray-900 tracking-tight tabular-nums"><?php echo e($totalResellers); ?></h3>
        ...
        <div class="bg-white p-6 rounded-2xl border border-gray-100 shadow-sm hover:shadow-md transition-all group duration-300 flex flex-col justify-between h-full">
            ...
            <div>
                <h3 class="text-2xl font-black text-gray-900 tracking-tight tabular-nums"><?php echo e(number_format($totalOrdersCount)); ?></h3>
        ...
        <div class="bg-white p-6 rounded-2xl border border-gray-100 shadow-sm hover:shadow-md transition-all group duration-300 flex flex-col justify-between h-full">
            ...
            <div>
                <h3 class="text-2xl font-black text-gray-900 tracking-tight tabular-nums">RM<?php echo e(number_format($totalRevenue, 2)); ?></h3>
    ...
    <div x-data="{ 
            ...
            async fetchResellers(url = null) {
                ...
                let targetUrl = url || `<?php echo e(route('admin.resellers.index')); ?>?${params.toString()}`;
                try {
        ...
        <div class="bg-white p-4 rounded-2xl border border-gray-100 shadow-sm">
            <form id="search-form" @submit.prevent="fetchResellers()" class="flex flex-col sm:flex-row gap-3">
                <div class="relative flex-1">
                    ...
                    <input type="text" name="search" value="<?php echo e(request('search')); ?>" placeholder="Search partners by name or email…" 
                ...
                <div class="flex gap-2">
                    ...
                    <a href="<?php echo e(route('admin.resellers.index')); ?>" class="px-6 py-3 bg-white border border-gray-200 text-gray-400 hover:text-black text-xs font-bold uppercase tracking-widest rounded-xl transition-all flex items-center justify-center">Reset</a>
                </div>
            </form>
        </div>
        ...
        <div class="bg-white rounded-2xl border border-gray-100 shadow-sm overflow-hidden mb-12 relative">
            ...
            <div id="table-container">
                <?php echo $__env->make('admin.resellers.partials.table', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
            </div>
        </div>
    </div>
...
<?php endif; ?>
<?php /**PATH C:\Users\USER\Documents\Project Code\reef_inventory\resources\views/admin/resellers/index.blade.php ENDPATH**/ ?>