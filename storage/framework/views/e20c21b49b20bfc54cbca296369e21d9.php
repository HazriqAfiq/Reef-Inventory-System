...
<?php $component->withAttributes(['title' => 'Add Reseller']); ?>
    ...
    <div class="bg-white rounded-2xl border border-gray-100 shadow-sm overflow-hidden mb-12">
        ...
        <form action="<?php echo e(route('admin.resellers.store')); ?>" method="POST" class="p-8 space-y-12">
            <?php echo csrf_field(); ?>
            ...
            <div class="space-y-8">
                ...
                <div class="grid grid-cols-1 md:grid-cols-3 gap-8">
                    ...
                    <div class="space-y-2">
                        ...
                        <input id="name" name="name" type="text" value="<?php echo e(old('name')); ?>" autofocus placeholder="e.g. Ahmad Rizal" required
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div class="space-y-2">
                        ...
                        <input id="email" name="email" type="email" value="<?php echo e(old('email')); ?>" placeholder="reseller@example.com" required
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div class="space-y-2">
                        ...
                        <input id="commission_rate" name="commission_rate" type="number" step="0.01" value="<?php echo e(old('commission_rate', 15.00)); ?>" placeholder="e.g. 15.00" required
...
<?php endif; ?>
<?php /**PATH C:\Users\USER\Documents\Project Code\reef_inventory\resources\views/admin/resellers/create.blade.php ENDPATH**/ ?>