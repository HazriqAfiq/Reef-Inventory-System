                                        ...
                                        <div class="flex flex-wrap items-center gap-3">
                                            <?php if($product->volume_ml): ?>
                                                <span class="px-3 py-1 bg-black text-white text-[9px] font-black uppercase tracking-widest rounded-md">
                                                    <?php echo e($product->volume_ml); ?>ML Volume
                                                </span>
                                            <?php endif; ?>
                                        </div>
                                        <h1 class="text-2xl lg:text-3xl font-black text-gray-900 tracking-tight leading-none pt-1"><?php echo e($product->name); ?></h1>
                                        <p class="text-[10px] font-bold text-gray-400 uppercase tracking-wider">SKU Code: <span class="text-gray-900 font-black"><?php echo e($product->sku); ?></span></p>
                                    </div>
                                    ...
                                    <div class="bg-gradient-to-br from-gray-50 to-white border border-gray-100 rounded-2xl p-6 shadow-sm">
                                        <div class="grid grid-cols-3 gap-6 items-center">
                                            ...
                                            <div class="space-y-1">
                                                ...
                                                <p class="text-xl font-black text-gray-900 tracking-tight">RM<?php echo e(number_format($product->wholesale_price, 2)); ?></p>
                                            ...
                                            <div class="space-y-1 border-l border-gray-100 pl-6">
                                                ...
                                                <p class="text-lg font-bold text-gray-900 tracking-tight">RM<?php echo e(number_format($product->retail_price, 2)); ?></p>
                                            ...
                                            <div class="space-y-1 border-l border-gray-100 pl-4 bg-amber-50/50 p-3 rounded-xl border border-amber-100/50">
                                                ...
                                                <p class="text-lg font-black text-amber-700 tracking-tight">+RM<?php echo e(number_format($profit, 2)); ?></p>
                                                <p class="text-[9px] font-black text-amber-600 uppercase tracking-wider mt-0.5"><?php echo e($margin); ?>% ROI</p>
                                            </div>
                                    ...
                                    <div class="space-y-4">
                                        ...
                                        <div class="grid grid-cols-3 gap-3">
                                            <div class="p-3 bg-gray-50/50 border border-gray-100 rounded-xl space-y-1">
                                                ...
                                                <p class="text-[11px] font-bold text-gray-800 leading-snug"><?php echo e($product->top_note ?: 'Subtle citrus aura'); ?></p>
                                            </div>
                                            
                                            <div class="p-3 bg-gray-50/50 border border-gray-100 rounded-xl space-y-1">
                                                <span class="text-[8px] font-black text-gray-400 uppercase tracking-widest">Heart Note</span>
                                                <p class="text-[11px] font-bold text-gray-800 leading-snug"><?php echo e($product->heart_note ?: 'Exotic florals'); ?></p>
                                            </div>

                                            <div class="p-3 bg-gray-50/50 border border-gray-100 rounded-xl space-y-1">
                                                <span class="text-[8px] font-black text-gray-400 uppercase tracking-widest">Base Note</span>
                                                <p class="text-[11px] font-bold text-gray-800 leading-snug"><?php echo e($product->base_note ?: 'Amber musk'); ?></p>
                                            </div>
                                        </div>
                                    </div>
