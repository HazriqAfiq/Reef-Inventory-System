                ...
                <tr class="hover:bg-gray-50/50 transition-colors">
                    ...
                    <td class="px-8 py-5">
                        <div class="flex items-center gap-3">
                            ...
                            <span class="text-xs font-bold text-gray-900 truncate"><?php echo e($sale->user->name ?? 'Walk-in / POS'); ?></span>
                        </div>
                    </td>
...
<?php endif; ?>
<?php /**PATH C:\Users\USER\Documents\Project Code\reef_inventory\resources\views/admin/sales/partials/table.blade.php ENDPATH**/ ?>