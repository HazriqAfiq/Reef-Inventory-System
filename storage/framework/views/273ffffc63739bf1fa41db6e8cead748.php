                ...
                <tr class="hover:bg-gray-50/50 transition-all duration-200">
                        ...
                        <div class="flex items-center gap-4">
                            ...
                            <div class="w-12 h-12 bg-gray-50 border border-gray-100 rounded-xl flex items-center justify-center overflow-hidden shrink-0 shadow-sm">
                                <?php if($product->primaryImage): ?>
                                    <img src="<?php echo e(asset('storage/' . $product->primaryImage->image_path)); ?>" class="w-full h-full object-cover transition-transform duration-500 hover:scale-110">
                                <?php else: ?>
                            ...
                            <!-- Product Details -->
                            <div>
                                <p class="text-sm font-bold text-gray-900 leading-snug"><?php echo e($product->name); ?></p>
                                <div class="flex items-center gap-1.5 mt-1">
                                    <span class="font-mono text-[9px] font-bold text-gray-400 bg-gray-50 px-1.5 py-0.5 rounded border border-gray-100 leading-none uppercase tracking-wider"><?php echo e($product->sku); ?></span>
                                    <?php if($product->category): ?>
                                        <span class="text-[9px] font-black text-indigo-500 uppercase tracking-widest bg-indigo-50 px-2 py-0.5 rounded leading-none border border-indigo-100/50"><?php echo e($product->category->name); ?></span>
                                    <?php endif; ?>
                                </div>
                            </div>
                        </div>
                    ...
                    <td class="px-8 py-4 text-right whitespace-nowrap">
                        <div class="inline-flex flex-col items-end">
                            <p class="text-sm font-black text-gray-900 leading-none">RM<?php echo e(number_format($product->retail_price, 2)); ?></p>
                            <span class="text-[9px] font-black text-emerald-600 bg-emerald-50 px-1.5 py-0.5 rounded mt-1.5 leading-none border border-emerald-100 uppercase tracking-widest">WS: RM<?php echo e(number_format($product->wholesale_price, 2)); ?></span>
                        </div>
                    </td>
                    ...
                    <td class="px-8 py-4 min-w-[200px]">
                        ...
                        <div class="mb-2 flex items-center justify-between gap-4">
                            <span class="text-sm font-black text-gray-900 tabular-nums">
                                <?php echo e(number_format($combinedStock)); ?> 
                            ...
                            <span class="text-[9px] font-bold text-gray-400 uppercase tracking-wider whitespace-nowrap">
                                <span class="text-gray-900 font-black"><?php echo e($adminStockTotal); ?></span> ADM &middot; <span class="text-gray-950 font-black"><?php echo e($product->reseller_stocks_sum_quantity ?? 0); ?></span> RES
                            </span>
                        </div>
                    ...
                    <td class="px-8 py-4 text-right whitespace-nowrap">
                        <div class="flex items-center justify-end gap-2">
                            <a href="<?php echo e(route('admin.products.edit', $product)); ?>" class="w-8 h-8 rounded-lg flex items-center justify-center bg-gray-50 border border-gray-100 text-gray-400 hover:bg-black hover:text-white hover:border-black transition-all hover:scale-105 active:scale-95" title="Edit">
                            ...
                            <button type="button" onclick="confirmDelete('<?php echo e(route('admin.products.destroy', $product)); ?>', '<?php echo e(addslashes($product->name)); ?>')" class="w-8 h-8 rounded-lg flex items-center justify-center bg-gray-50 border border-gray-100 text-gray-400 hover:bg-rose-50 hover:text-rose-600 hover:border-rose-200 transition-all hover:scale-105 active:scale-95" title="Delete">
...
<?php if(method_exists($products, 'nextPageUrl') && $products->nextPageUrl()): ?>
    <div id="admin-products-load-more-wrapper" class="px-6 py-5 border-t border-gray-50 flex justify-center">
        <button id="btn-admin-products-load-more" 
                data-next-url="<?php echo e($products->nextPageUrl()); ?>" 
...
<?php /**PATH C:\Users\USER\Documents\Project Code\reef_inventory\resources\views/admin/products/partials/table.blade.php ENDPATH**/ ?>