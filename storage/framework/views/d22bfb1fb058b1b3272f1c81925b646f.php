    ...
    <div class="grid grid-cols-2 lg:grid-cols-4 gap-4 mb-8">
        ...
        <div class="bg-white p-5 rounded-2xl border border-gray-100 shadow-sm hover:shadow-md transition-all group duration-300 flex flex-col justify-between h-full">
            <div>
                ...
                <h3 class="text-2xl font-black text-gray-900 tracking-tight tabular-nums truncate"><?php echo e(number_format($totalStock)); ?></h3>
            </div>
            <p class="text-[9px] text-emerald-600 font-bold uppercase tracking-wider mt-2 leading-none">
                <span class="text-gray-950 font-black"><?php echo e(number_format($adminStock)); ?></span> ADM &middot; <span class="text-gray-950 font-black"><?php echo e(number_format($resellerStock)); ?></span> RES
            </p>
        </div>
        ...
        <div class="bg-white p-5 rounded-2xl border border-gray-100 shadow-sm hover:shadow-md transition-all group duration-300 flex flex-col justify-between h-full">
            <div>
                ...
                <h3 class="text-2xl font-black text-gray-900 tracking-tight tabular-nums truncate"><?php echo e(number_format($lowStockCount)); ?></h3>
            </div>
        ...
        <div class="bg-white p-5 rounded-2xl border border-gray-100 shadow-sm hover:shadow-md transition-all group duration-300 flex flex-col justify-between h-full">
            <div>
                ...
                <h3 class="text-2xl font-black text-gray-900 tracking-tight tabular-nums truncate"><?php echo e(number_format($outOfStock)); ?></h3>
            </div>
    ...
    <div class="bg-white p-4 rounded-2xl border border-gray-100 shadow-sm mb-8">
        <form id="filter-form" method="GET" action="<?php echo e(route('admin.products.index')); ?>" class="flex flex-col lg:flex-row gap-4">
            ...
            <?php if(request()->hasAny(['search', 'stock', 'volume', 'sort'])): ?>
                <a href="<?php echo e(route('admin.products.index')); ?>" class="px-6 py-3 text-[10px] font-black text-gray-400 hover:text-black bg-white border border-gray-100 rounded-xl text-center uppercase tracking-widest transition-all">Reset</a>
            <?php endif; ?>
        </form>
    </div>
...
<?php endif; ?>
<?php /**PATH C:\Users\USER\Documents\Project Code\reef_inventory\resources\views/admin/products/index.blade.php ENDPATH**/ ?>