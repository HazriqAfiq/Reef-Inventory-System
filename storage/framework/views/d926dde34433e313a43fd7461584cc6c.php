    ...
    <div class="bg-white rounded-2xl border border-gray-100 shadow-sm overflow-hidden mb-12">
        ...
        <div class="px-8 py-6 border-b border-gray-50 bg-gray-50/20 flex flex-col sm:flex-row sm:items-center justify-between gap-4">
            <div>
                ...
                <p class="text-sm text-gray-500 mt-1.5"><?php echo e($product->name); ?> &middot; <span class="font-mono text-[10px] font-bold uppercase tracking-widest bg-gray-100 px-2 py-0.5 rounded-lg border border-gray-200"><?php echo e($product->sku); ?></span></p>
            </div>
