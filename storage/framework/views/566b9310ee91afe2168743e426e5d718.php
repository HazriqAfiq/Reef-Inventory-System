...
<?php endif; ?>
<?php $component->withAttributes(['title' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute($title ?? 'System Settings')]); ?>
    ...
    <div class="mb-8 flex flex-col md:flex-row md:items-center md:justify-between gap-4">
        <div>
            ...
            <h1 class="text-3xl font-black text-gray-900 tracking-tight"><?php echo e($title ?? 'System Configuration'); ?></h1>
...
<?php endif; ?>
<?php /**PATH C:\Users\USER\Documents\Project Code\reef_inventory\resources\views/admin/settings/page.blade.php ENDPATH**/ ?>