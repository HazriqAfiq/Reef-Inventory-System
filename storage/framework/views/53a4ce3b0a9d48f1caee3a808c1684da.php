    ...
    <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 mb-10">
        ...
        <div class="bg-white p-6 rounded-2xl border border-gray-100 shadow-sm">
            ...
            <div class="flex items-end justify-between">
                <h3 class="text-2xl font-bold text-gray-900 tabular-nums">RM<?php echo e(number_format($wholesaleRevenue, 0)); ?></h3>
        ...
        <div class="bg-white p-6 rounded-2xl border border-gray-100 shadow-sm">
            ...
            <div class="flex items-end justify-between">
                <h3 class="text-2xl font-bold text-gray-900 tabular-nums"><?php echo e(number_format($wholesaleUnitsSold)); ?></h3>
        ...
        <div class="bg-white p-6 rounded-2xl border border-gray-100 shadow-sm">
            ...
            <div class="flex items-end justify-between">
                <h3 class="text-2xl font-bold text-gray-900 tabular-nums"><?php echo e($activeResellers); ?></h3>
        ...
        <div class="bg-white p-6 rounded-2xl border border-gray-100 shadow-sm">
            ...
            <div class="flex items-end justify-between">
                <h3 class="text-2xl font-bold text-gray-900 tabular-nums"><?php echo e(number_format($adminStock)); ?></h3>
                <?php if($lowStockCount > 0): ?>
                    <span class="text-[10px] font-bold text-amber-600 bg-amber-50 px-2 py-1 rounded-lg"><?php echo e($lowStockCount); ?> Alerts</span>
                <?php else: ?>
            ...
            <div class="divide-y divide-gray-50">
                <?php $__currentLoopData = $recentWholesaleOrders; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $order): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <div class="px-6 py-4 flex items-center justify-between hover:bg-gray-50/50 transition-all">
                        <div>
                            <p class="text-xs font-bold text-gray-900 truncate w-32"><?php echo e($order->user->name); ?></p>
                            <p class="text-[9px] text-gray-400 uppercase tracking-widest mt-0.5"><?php echo e($order->created_at->diffForHumans()); ?></p>
                        </div>
                        <div class="flex items-center gap-3">
                            <span class="inline-flex px-2 py-0.5 rounded text-[8px] font-bold uppercase tracking-widest <?php echo e($order->status === 'paid' ? 'bg-emerald-50 text-emerald-600' : 'bg-amber-50 text-amber-600'); ?>">
                                <?php echo e($order->status); ?>

                            </span>
                            <span class="text-xs font-bold text-gray-900">RM<?php echo e(number_format($order->total_price, 0)); ?></span>
                        </div>
                    </div>
