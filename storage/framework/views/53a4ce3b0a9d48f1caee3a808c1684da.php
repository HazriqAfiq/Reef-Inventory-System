...
<?php $component->withAttributes(['title' => 'Command Center']); ?>
    ...
    <div class="grid grid-cols-2 lg:grid-cols-6 gap-4 mb-8">
        ...
        <div class="bg-white p-5 rounded-2xl border border-gray-100 shadow-sm hover:shadow-md transition-all group duration-300">
            ...
            <h3 class="text-2xl font-black text-gray-900 tracking-tight tabular-nums"><?php echo e(number_format($lowStockProductsCount)); ?></h3>
        ...
        <div class="bg-white p-5 rounded-2xl border border-gray-100 shadow-sm hover:shadow-md transition-all group duration-300">
            ...
            <h3 class="text-2xl font-black text-gray-900 tracking-tight tabular-nums"><?php echo e(number_format($pendingOrdersCount)); ?></h3>
        ...
        <div class="bg-white p-5 rounded-2xl border border-gray-100 shadow-sm hover:shadow-md transition-all group duration-300">
            ...
            <h3 class="text-2xl font-black text-gray-900 tracking-tight tabular-nums"><?php echo e(number_format($totalResellers)); ?></h3>
        ...
        <div class="bg-white p-5 rounded-2xl border border-gray-100 shadow-sm hover:shadow-md transition-all group duration-300">
            ...
            <h3 class="text-lg font-black text-gray-900 tracking-tight tabular-nums truncate">RM<?php echo e(number_format($monthlyRevenue, 0)); ?></h3>
    ...
    <div class="grid grid-cols-1 lg:grid-cols-3 gap-8 mb-8">
                            ...
                            <div class="flex items-center justify-between p-3 bg-slate-50/30 border border-slate-100/50 rounded-xl hover:bg-slate-50/80 transition-colors">
                                ...
                                <div class="text-right shrink-0">
                                    <div class="text-xs font-black text-gray-900 tabular-nums">
                                        <?php echo e(number_format($product->wholesale_qty ?? 0)); ?> units
                                    </div>
                                    <div class="text-[10px] font-bold text-emerald-600 mt-0.5">
                                        RM<?php echo e(number_format($product->wholesale_revenue ?? 0, 2)); ?>
        ...
        <div class="bg-white rounded-2xl border border-gray-100 shadow-sm overflow-hidden flex flex-col">
            ...
            <div class="p-6 flex-1">
                <?php if(isset($topResellers) && $topResellers->count() > 0): ?>
                    <div class="space-y-3">
                        <?php $__currentLoopData = $topResellers; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $reseller): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <div class="flex items-center justify-between p-3 bg-indigo-50/10 border border-indigo-100/30 rounded-xl hover:bg-indigo-50/30 transition-colors">
                                <div class="min-w-0 mr-3">
                                    <h4 class="text-xs font-bold text-gray-900 truncate"><?php echo e($reseller->name); ?></h4>
                                    <p class="text-[9px] text-gray-400 font-bold uppercase tracking-widest mt-0.5 truncate"><?php echo e($reseller->email); ?></p>
                                </div>
                                <div class="text-right shrink-0">
                                    <div class="text-xs font-black text-indigo-600 tabular-nums">
                                        RM<?php echo e(number_format($reseller->wholesale_spend ?? 0, 2)); ?>

                                    </div>
                                    <div class="text-[9px] text-gray-400 font-bold mt-0.5">
                                        <?php echo e($reseller->orders_count); ?> <?php echo e(Str::plural('order', $reseller->orders_count)); ?>
        ...
        <div class="bg-white rounded-2xl border border-gray-100 shadow-sm overflow-hidden flex flex-col">
            ...
            <div class="p-6 flex-1 space-y-4">
                <?php $__empty_1 = true; $__currentLoopData = $mostActiveResellers; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $reseller): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                    <div class="flex items-center justify-between text-xs">
                        <div class="min-w-0 mr-2">
                            <h4 class="font-bold text-gray-900 truncate"><?php echo e($reseller->name); ?></h4>
                            <p class="text-[9px] text-indigo-600 font-bold uppercase tracking-wider mt-0.5">RM<?php echo e(number_format($reseller->wholesale_spend ?? 0, 2)); ?> • <?php echo e($reseller->orders_count); ?> orders</p>
                        </div>
                        <a href="<?php echo e(route('admin.resellers.index')); ?>" class="text-[9px] font-black uppercase tracking-wider bg-gray-50 border border-gray-100 hover:bg-gray-100 text-black px-2 py-1.5 rounded-lg shadow-sm shrink-0">
                            View
                        </a>
                    </div>
                    ...
                    <?php $__empty_1 = true; $__currentLoopData = $recentOrders; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $order): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                        <tr class="hover:bg-gray-50/50 transition-colors">
                            ...
                            <td class="px-6 py-4 text-center">
                                <?php if(($order->total_quantity ?? 0) >= 15): ?>
