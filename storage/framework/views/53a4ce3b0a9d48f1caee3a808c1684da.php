...
<?php endif; ?>
<?php $component->withAttributes(['title' => 'Command Center']); ?>
    <!-- Page Header -->
    ...
    <div class="grid grid-cols-2 lg:grid-cols-7 gap-4 mb-8">
        ...
        <div class="bg-white p-5 rounded-2xl border border-gray-100 shadow-sm hover:shadow-md transition-all group duration-300 flex flex-col justify-between h-full">
            <div>
                ...
                <h3 class="text-2xl font-black text-gray-900 tracking-tight tabular-nums truncate">RM<?php echo e(number_format($totalRevenue, 0)); ?></h3>
            </div>
        ...
        <div class="bg-white p-5 rounded-2xl border border-gray-100 shadow-sm hover:shadow-md transition-all group duration-300 flex flex-col justify-between h-full">
            <div>
                ...
                <h3 class="text-2xl font-black text-gray-900 tracking-tight tabular-nums truncate">RM<?php echo e(number_format($monthlyRevenue, 0)); ?></h3>
            </div>
            <p class="text-[9px] text-rose-600 font-bold uppercase tracking-wider mt-2 leading-none">
                <?php echo e($monthlyOrdersCount); ?> <?php echo e(Str::plural('order', $monthlyOrdersCount)); ?> this month
            </p>
        </div>
        ...
        <div class="bg-white p-5 rounded-2xl border border-gray-100 shadow-sm hover:shadow-md transition-all group duration-300 flex flex-col justify-between h-full">
            <div>
                ...
                <h3 class="text-2xl font-black text-gray-900 tracking-tight tabular-nums truncate"><?php echo e(number_format($totalProducts)); ?></h3>
            </div>
        ...
        <div class="bg-white p-5 rounded-2xl border border-gray-100 shadow-sm hover:shadow-md transition-all group duration-300 flex flex-col justify-between h-full">
            <div>
                ...
                <h3 class="text-2xl font-black text-gray-900 tracking-tight tabular-nums truncate"><?php echo e(number_format($totalStockUnits)); ?></h3>
            </div>
        ...
        <div class="bg-white p-5 rounded-2xl border border-gray-100 shadow-sm hover:shadow-md transition-all group duration-300 flex flex-col justify-between h-full">
            <div>
                ...
                <h3 class="text-2xl font-black text-gray-900 tracking-tight tabular-nums truncate"><?php echo e(number_format($lowStockProductsCount)); ?></h3>
            </div>
        ...
        <div class="bg-white p-5 rounded-2xl border border-gray-100 shadow-sm hover:shadow-md transition-all group duration-300 flex flex-col justify-between h-full">
            <div>
                ...
                <h3 class="text-2xl font-black text-gray-900 tracking-tight tabular-nums truncate"><?php echo e(number_format($outOfStockProductsCount)); ?></h3>
            </div>
        ...
        <div class="bg-white p-5 rounded-2xl border border-gray-100 shadow-sm hover:shadow-md transition-all group duration-300 flex flex-col justify-between h-full">
            <div>
                ...
                <h3 class="text-2xl font-black text-gray-900 tracking-tight tabular-nums truncate"><?php echo e(number_format($totalResellers)); ?></h3>
            </div>
        ...
        <div class="bg-white rounded-2xl border border-gray-100 shadow-sm overflow-hidden flex flex-col">
            ...
            <div class="p-6 flex-1 overflow-y-auto max-h-[300px]">
                <div class="space-y-3">
                    ...
                    <?php $__currentLoopData = $outOfStockItems; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $product): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <?php $hasAlerts = true; ?>
                        <div class="flex items-center justify-between p-3 bg-rose-50/20 border border-rose-100/50 rounded-xl hover:bg-rose-50/50 transition-colors">
                            <div class="flex items-center gap-3 min-w-0">
                                ...
                                <div class="min-w-0">
                                    <h4 class="text-xs font-bold text-gray-900 truncate"><?php echo e($product->name); ?></h4>
                                    <p class="text-[9px] text-gray-400 font-bold uppercase tracking-widest mt-0.5"><?php echo e($product->sku); ?></p>
                                </div>
                            </div>
                            <div class="flex items-center gap-3 shrink-0">
                                ...
                                <a href="<?php echo e(route('admin.products.edit', $product)); ?>" class="text-[10px] font-black uppercase tracking-wider text-black hover:opacity-75 transition-opacity px-2.5 py-1.5 bg-white border border-gray-150 rounded-lg shadow-sm">
                                    Restock
                                </a>
                            </div>
                        </div>
                    ...
                    <?php $__currentLoopData = $lowStockItems; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $product): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        ...
                        <div class="flex items-center justify-between p-3 bg-amber-50/20 border border-amber-100/50 rounded-xl hover:bg-amber-50/50 transition-colors">
                            ...
                            <div class="flex items-center gap-3 shrink-0">
                                <div class="text-right">
                                    <span class="text-[10px] font-black text-amber-600 tabular-nums bg-amber-50 border border-amber-100 px-2.5 py-1 rounded-lg"><?php echo e($product->stock); ?> left</span>
                                </div>
                                <a href="<?php echo e(route('admin.products.edit', $product)); ?>" class="text-[10px] font-black uppercase tracking-wider text-black hover:opacity-75 transition-opacity px-2.5 py-1.5 bg-white border border-gray-150 rounded-lg shadow-sm">
                                    Restock
                                </a>
    ...
    <div x-data="{
        activeFilter: 'month',
        resellerTotals: {
            month: <?php echo e($topResellersMonth->sum('wholesale_spend')); ?>,
            year: <?php echo e($topResellersYear->sum('wholesale_spend')); ?>,
            total: <?php echo e($topResellersTotal->sum('wholesale_spend')); ?>
        ...
        <div class="bg-white rounded-2xl border border-gray-100 shadow-sm overflow-hidden flex flex-col h-full">
            ...
            <div class="p-6 flex-1 flex flex-col justify-center items-center">
                <?php if(isset($topSellingProducts) && $topSellingProducts->count() > 0): ?>
        ...
        <div class="bg-white rounded-2xl border border-gray-100 shadow-sm overflow-hidden flex flex-col h-full">
            ...
            <div class="p-6 flex-1 flex flex-col justify-center items-center">
                <?php if(isset($topResellers) && $topResellers->count() > 0): ?>
                    <div class="w-full h-[180px] md:h-[220px] lg:h-[280px] relative">
    ...
    <div class="bg-white rounded-2xl border border-gray-100 shadow-sm overflow-hidden flex flex-col mb-10">
        <div class="px-6 py-4 border-b border-gray-50 bg-gray-50/20 shrink-0 flex items-center justify-between">
            ...
            <a href="<?php echo e(route('admin.orders.index')); ?>" class="text-[10px] font-black uppercase tracking-wider text-black hover:underline shrink-0">
                ...
                <tbody class="divide-y divide-gray-100 text-xs font-medium text-gray-700">
                    <?php $__empty_1 = true; $__currentLoopData = $recentOrders; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $order): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                        <tr class="hover:bg-gray-50/50 transition-colors">
                            <td class="px-6 py-4">
                                <a href="<?php echo e(route('admin.orders.show', $order)); ?>" class="font-black text-black hover:underline">
                                    #<?php echo e($order->id); ?>

                                </a>
                                <p class="text-[9px] text-gray-400 font-semibold mt-0.5"><?php echo e($order->created_at->diffForHumans()); ?></p>
                            </td>
                            <td class="px-6 py-4">
                                <div class="font-bold text-gray-900"><?php echo e($order->user->name); ?></div>
                                <div class="text-[9px] text-gray-400 font-bold uppercase tracking-wider mt-0.5 truncate max-w-[150px]"><?php echo e($order->user->email); ?></div>
                            </td>
                            <td class="px-6 py-4 text-center font-bold text-gray-900 tabular-nums">
                                <?php echo e($order->total_quantity ?? 0); ?>
    ...
    <script>
                ...
                data: {
                    ...
                    datasets: [
                        ...
                        },
                        {
                            ...
                            data: <?php echo json_encode($trendCount, 15, 512) ?>,
                            borderColor: '#6366f1',
        ...
        const productDatasets = {
            month: {
                labels: <?php echo json_encode($topSellingProductsMonth->pluck('name'), 15, 512) ?>,
                qty: <?php echo json_encode($topSellingProductsMonth->map(fn($p) => (int)($p->wholesale_qty ?? 0))->values(), 15, 512) ?>,
                revenue: <?php echo json_encode($topSellingProductsMonth->map(fn($p) => round((float)($p->wholesale_revenue ?? 0), 2))->values(), 512) ?>
            },
            year: {
                labels: <?php echo json_encode($topSellingProductsYear->pluck('name'), 15, 512) ?>,
                qty: <?php echo json_encode($topSellingProductsYear->map(fn($p) => (int)($p->wholesale_qty ?? 0))->values(), 15, 512) ?>,
                revenue: <?php echo json_encode($topSellingProductsYear->map(fn($p) => round((float)($p->wholesale_revenue ?? 0), 2))->values(), 512) ?>
            },
            total: {
                labels: <?php echo json_encode($topSellingProductsTotal->pluck('name'), 15, 512) ?>,
                qty: <?php echo json_encode($topSellingProductsTotal->map(fn($p) => (int)($p->wholesale_qty ?? 0))->values(), 15, 512) ?>,
                revenue: <?php echo json_encode($topSellingProductsTotal->map(fn($p) => round((float)($p->wholesale_revenue ?? 0), 2))->values(), 512) ?>
            }
        };

        const resellerDatasets = {
            month: {
                labels: <?php echo json_encode($topResellersMonth->pluck('name'), 15, 512) ?>,
                spend: <?php echo json_encode($topResellersMonth->map(fn($r) => round((float)($r->wholesale_spend ?? 0), 2))->values(), 512) ?>,
                items: <?php echo json_encode($topResellersMonth->map(fn($r) => (int)($r->wholesale_items ?? 0))->values(), 15, 512) ?>,
                orders: <?php echo json_encode($topResellersMonth->pluck('orders_count'), 15, 512) ?>
            },
            year: {
                labels: <?php echo json_encode($topResellersYear->pluck('name'), 15, 512) ?>,
                spend: <?php echo json_encode($topResellersYear->map(fn($r) => round((float)($r->wholesale_spend ?? 0), 2))->values(), 512) ?>,
                items: <?php echo json_encode($topResellersYear->map(fn($r) => (int)($r->wholesale_items ?? 0))->values(), 15, 512) ?>,
                orders: <?php echo json_encode($topResellersYear->pluck('orders_count'), 15, 512) ?>
            },
            total: {
                labels: <?php echo json_encode($topResellersTotal->pluck('name'), 15, 512) ?>,
                spend: <?php echo json_encode($topResellersTotal->map(fn($r) => round((float)($r->wholesale_spend ?? 0), 2))->values(), 512) ?>,
                items: <?php echo json_encode($topResellersTotal->map(fn($r) => (int)($r->wholesale_items ?? 0))->values(), 15, 512) ?>,
                orders: <?php echo json_encode($topResellersTotal->pluck('orders_count'), 15, 512) ?>
            }
        };
...
<?php endif; ?>
<?php /**PATH C:\Users\USER\Documents\Project Code\reef_inventory\resources\views/admin/dashboard.blade.php ENDPATH**/ ?>