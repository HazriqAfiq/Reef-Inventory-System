...
<?php endif; ?>
<?php $component->withAttributes(['title' => 'Promotion Management']); ?>
    ...
    <div class="space-y-16 pb-32">
        ...
        <div class="space-y-8" x-data="{ 
                ...
                async searchProducts() {
                    ...
                    const response = await fetch(`<?php echo e(route('admin.api.products.search')); ?>?q=${this.search}`);
            ...
            <div class="bg-white rounded-2xl border border-gray-100 shadow-sm overflow-hidden">
                <form action="<?php echo e(route('admin.settings.globalPromotion')); ?>" method="POST" id="globalPromoForm" class="p-8">
                    <?php echo csrf_field(); ?>
                    ...
                    <div class="grid grid-cols-1 lg:grid-cols-2 gap-16">
                        ...
                        <div class="space-y-8">
                            ...
                            <div x-show="targetScope === 'individual'" x-cloak class="space-y-4"
                                 x-data="{ isOpen: false, allProducts: [], async init() { const r = await fetch(`<?php echo e(route('admin.api.products.search')); ?>`); this.allProducts = await r.json(); } }"
                ...
                <div class="overflow-x-auto">
                    <table class="w-full text-left">
                        ...
                        <tbody class="divide-y divide-gray-50">
                            <?php $__empty_1 = true; $__currentLoopData = $productsOnPromotion; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $product): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                        ...
                                        <div class="flex items-center gap-4">
                                            <div class="w-12 h-12 rounded-xl bg-gray-50 border border-gray-100 p-1 shrink-0 overflow-hidden">
                                                <?php if($product->primaryImage): ?>
                                                    <img src="<?php echo e(asset('storage/' . $product->primaryImage->image_path)); ?>" class="w-full h-full object-cover rounded-lg">
                                                <?php endif; ?>
                                            </div>
                                            <div>
                                                <p class="text-xs font-bold text-gray-900"><?php echo e($product->name); ?></p>
                                                <p class="text-[9px] text-gray-400 font-bold uppercase tracking-widest"><?php echo e($product->sku); ?></p>
                                            </div>
                                        </div>
                                    </td>
                                    <td class="px-8 py-6">
                                        <span class="inline-flex px-3 py-1 rounded-full text-[9px] font-bold uppercase tracking-widest <?php echo e($product->promotion_type === 'bogo' ? 'bg-black text-white' : 'bg-gray-100 text-gray-600'); ?>">
                                            <?php echo e($product->promotion_type === 'bogo' ? 'BOGO' : 'Discount'); ?>

                                        </span>
                                    </td>
                                    <td class="px-8 py-6">
                                        <p class="text-sm font-bold text-gray-900"><?php echo e($product->promotion_type === 'discount_percent' ? $product->promotion_value . '%' : 'Buy 1 Get 1'); ?></p>
                                    </td>
                                    <td class="px-8 py-6 text-right">
                                        <form action="<?php echo e(route('admin.settings.removeProductPromotion', $product)); ?>" method="POST" class="inline-block">
                                            <?php echo csrf_field(); ?>
...
<?php endif; ?>
<?php /**PATH C:\Users\USER\Documents\Project Code\reef_inventory\resources\views/admin/settings/promotion.blade.php ENDPATH**/ ?>