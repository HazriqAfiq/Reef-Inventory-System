...
<?php endif; ?>
<?php $component->withAttributes(['title' => 'Inventory Audit Workspace']); ?>
    <div class="relative">
        ...
        <form action="<?php echo e(route('reseller.dashboard.audit')); ?>" method="POST" 
            ...
            <div class="bg-white p-6 rounded-2xl border border-gray-100 shadow-sm flex flex-col md:flex-row md:items-center justify-between gap-6">
                <div class="flex items-center gap-4">
                    ...
                    <div>
                        <h4 class="text-sm font-black text-gray-900 uppercase tracking-widest">Current Audit Health: <?php echo e($auditHealthPercentage); ?>%</h4>
            ...
            <div class="bg-white rounded-2xl border border-gray-100 shadow-sm overflow-hidden">
                <div class="px-8 py-4 border-b border-gray-50 bg-gray-50/20 flex items-center justify-between">
                    ...
                    <span class="text-[9px] text-gray-400 font-bold uppercase tracking-widest"><?php echo e($myStocks->count()); ?> Products Available</span>
                </div>

                <div class="divide-y divide-gray-100 p-6 space-y-4">
                    <?php $__currentLoopData = $myStocks; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $stock): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <div x-data="{ qty: <?php echo e($stock->quantity); ?>, originalQty: <?php echo e($stock->quantity); ?>, maxQty: <?php echo e($stock->total_restocked); ?> }"
                            ...
                            <div class="flex items-center gap-3.5 min-w-0">
                                ...
                                <div class="min-w-0">
                                    <h4 class="text-sm font-black text-gray-900 truncate"><?php echo e($stock->product?->name); ?></h4>
                                    <div class="flex items-center gap-1.5 mt-0.5 text-[9px] text-gray-400 font-bold uppercase tracking-widest">
                                        <span><?php echo e($stock->product?->sku); ?></span>
                                        <span>&middot;</span>
                                        <span><?php echo e($stock->product?->volume_ml); ?>ml</span>
                                    </div>
                                    <div class="mt-2 flex flex-wrap items-center gap-1.5 font-semibold">
                                        <span class="inline-flex items-center text-[8px] font-bold text-gray-500 bg-gray-100/80 px-2 py-0.5 rounded uppercase tracking-wider border border-gray-150">
                                            System Stock Exist: <?php echo e($stock->quantity); ?>
                                        ...
                                        <span class="inline-flex items-center text-[8px] font-black text-gray-700 bg-gray-150 px-2 py-0.5 rounded uppercase tracking-wider border border-gray-200 animate-pulse">
                                            Max Audit Limit: <?php echo e($stock->total_restocked); ?>
                            ...
                            <div class="flex items-center justify-between sm:justify-end gap-4 shrink-0 border-t sm:border-t-0 pt-3 sm:pt-0 border-gray-100">
                                ...
                                <div class="text-left sm:text-right flex flex-col items-start sm:items-end gap-1.5">
                                    ...
                                    <template x-if="qty === originalQty">
                                        <span class="px-2.5 py-1 rounded-lg text-[8px] font-black uppercase tracking-widest border <?php echo e($stock->freshness_badge_color); ?>">
                                            <?php echo e($stock->freshness_status); ?>

                                        </span>
                                    </template>
                                    <span class="text-[8px] text-gray-400 font-bold uppercase tracking-wider">Verified: <?php echo e($stock->updated_at ? $stock->updated_at->diffForHumans() : 'Never'); ?></span>
                                </div>
                                ...
                                <div class="flex items-center bg-white border border-gray-200 rounded-xl p-1 shadow-sm shrink-0">
                                    ...
                                    <input type="number" name="stocks[<?php echo e($stock->id); ?>]" x-model.number="qty" min="0" :max="maxQty" @input="if (qty > maxQty) qty = maxQty; if (isNaN(qty) || qty < 0) qty = 0;" class="w-12 bg-transparent border-0 text-center text-xs font-black focus:ring-0 p-0 text-gray-900">
                ...
                <div class="px-8 py-4 border-t border-gray-50 bg-gray-50/20 flex items-center justify-end gap-3 shrink-0">
                    <a href="<?php echo e(route('reseller.dashboard')); ?>" class="px-5 py-3 text-gray-600 text-xs font-black uppercase tracking-widest rounded-xl hover:bg-gray-100 transition-colors">
                        Cancel
                    </a>
...
<?php endif; ?>
<?php /**PATH C:\Users\USER\Documents\Project Code\reef_inventory\resources\views/reseller/audit/index.blade.php ENDPATH**/ ?>